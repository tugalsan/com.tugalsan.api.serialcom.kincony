...
public class TS_SerialComKinConyKC868_A32_R1_2_Chip {
    ...
    public static <T> TGS_UnionExcuse<T> call(TS_ThreadSyncTrigger killTrigger, String comX, TGS_FuncMTUCE_OutTyped_In1<TGS_UnionExcuse<T>, TS_SerialComKinConyKC868_A32_R1_2_Chip> chip) {
        return call(killTrigger, comX, chip, defaultTimeoutDuration());
    }

    public static <T> TGS_UnionExcuse<T> call(TS_ThreadSyncTrigger killTrigger, String comX, TGS_FuncMTUCE_OutTyped_In1<TGS_UnionExcuse<T>, TS_SerialComKinConyKC868_A32_R1_2_Chip> chip, Duration timeout) {
